namespace Loupedeck.Test_clipboardPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Test_clipboardPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.Test_clipboardPlugin.Resources.Resource.txt`.
