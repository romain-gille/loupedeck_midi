namespace Loupedeck.MidiLpdckPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MidiLpdckPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MidiLpdckPlugin.Resources.Resource.txt`.
